...
using BiliFor.Extensions;
using BiliFor.Filter;
using BiliFor.Hubs;
using BiliFor.IServices;
using BiliFor.Middlewares;
...
namespace BiliFor
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MyContext myContext, ITasksQzServices tasksQzServices, ISchedulerCenter schedulerCenter, IHostApplicationLifetime lifetime)
        {
            ...
            // 封装Swagger展示
            app.UseSwaggerMildd(() => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("BiliFor.Api.index.html"));
